...
def upgrade() -> None:
    ...
    op.create_table("users",
        ...
        sa.Column("role",            sa.Enum("CUSTOMER","PARTNER","ADMIN", name="user_role"), nullable=False),
    ...
    op.create_table("shops",
        ...
        sa.Column("team_type",    sa.Enum("DAY","NIGHT","BOTH", name="team_type"), nullable=False, server_default="'DAY'"),
    ...
    op.create_table("orders",
        ...
        sa.Column("service_type",     sa.Enum("DAY","NIGHT", name="service_type"), nullable=False),
        sa.Column("wash_category",    sa.Enum("CLOTHES_30L","CLOTHES_50L","BLANKET","SHOES", name="wash_category"), nullable=False),
        sa.Column("status",           sa.Enum("PENDING","ACCEPTED","PICKED_UP","WASHING","DRYING","DELIVERING","COMPLETED","CANCELLED", name="order_status"), nullable=False, server_default="'PENDING'"),
    ...
    op.create_table("order_status_history",
        ...
        sa.Column("old_status", sa.Enum("PENDING","ACCEPTED","PICKED_UP","WASHING","DRYING","DELIVERING","COMPLETED","CANCELLED", name="order_status")),
        sa.Column("new_status", sa.Enum("PENDING","ACCEPTED","PICKED_UP","WASHING","DRYING","DELIVERING","COMPLETED","CANCELLED", name="order_status"), nullable=False),
    ...
    op.create_table("order_photos",
        ...
        sa.Column("photo_type",  sa.Enum("PICKUP","DELIVERY","ISSUE", name="photo_type"), nullable=False),
    ...
    op.create_table("settlements",
        ...
        sa.Column("status",       sa.Enum("PENDING","PROCESSING","COMPLETED","FAILED", name="settlement_status"), nullable=False, server_default="'PENDING'"),
    ...
    op.create_table("notifications",
        ...
        sa.Column("user_id",     UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=False),
        sa.Column("order_id",    UUID(as_uuid=True), sa.ForeignKey("orders.id")),
        sa.Column("type",        sa.Enum("FCM","KAKAO","SMS", name="notification_type"), nullable=False),
    ...
    op.create_table("crm_campaigns",
        ...
        sa.Column("status",        sa.Enum("WAITING","SCHEDULED","SENT","FAILED", name="crm_status"), nullable=False, server_default="'WAITING'"),
