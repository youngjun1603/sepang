...
def upgrade() -> None:
    ...
    op.create_table("shops",
        ...
        sa.Column("team_type",    PG_ENUM(name="team_type", create_type=False), nullable=False, server_default=sa.text("'DAY'")),
    ...
    op.create_table("orders",
        ...
        sa.Column("status",           PG_ENUM(name="order_status", create_type=False), nullable=False, server_default=sa.text("'PENDING'")),
    ...
    op.create_table("order_photos",
        ...
        sa.Column("s3_bucket",   sa.Text, nullable=False, server_default=sa.text("'sepang-photos'")),
    ...
    op.create_table("settlements",
        ...
        sa.Column("status",       PG_ENUM(name="settlement_status", create_type=False), nullable=False, server_default=sa.text("'PENDING'")),
    ...
    op.create_table("crm_campaigns",
        ...
        sa.Column("status",        PG_ENUM(name="crm_status", create_type=False), nullable=False, server_default=sa.text("'WAITING'")),
